        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            <ul>
              ...
              <li>
                Use of the Application: Our Application facilitates toy sharing
                and exchange among users. Use it responsibly and in accordance
                with these Terms.
              </li>
              <li>
                Registration and Account: Create an account to access features.
                Provide accurate information during registration.
              </li>
              <li>
                User Content: You're responsible for content you upload. We have
                a license to use and distribute it.
              </li>
              <li>
                Toy Listings and Transactions: Users can list toys for sharing.
                We're not liable for toy quality or legality.
              </li>
              <li>
              ...
              <li>
                Limitation of Liability: We're not liable for indirect damages.
              </li>
